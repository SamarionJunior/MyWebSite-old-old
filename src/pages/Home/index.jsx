                ...
                <div className={Style.Painel}>
                    ...
                    <div className={Style.Description}>
                        ...
                        <div className={Style.Actions}>
                            <Link to="/Home" className={Style.Action} target="_blank" rel="noopener noreferrer">Web</Link>
                            <Link to="/Home" className={Style.Action} target="_blank" rel="noopener noreferrer">Git</Link>
                            <Link to="/Home" className={Style.Action} target="_blank" rel="noopener noreferrer">Apk</Link>
                        </div>
                    </div>
                </div>
